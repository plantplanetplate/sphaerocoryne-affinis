...
Sphaerocoryne affinis is an <span ve-entity title="angiosperm" eid="Q25314">angiosperm</span> or flowering plant belonging to the genus Sphaerocoryne within the family Annonaceae (Soursop family).   It is a mid-size tree which can grow from 8 to 15 meters tall, with yellow-brown bark.  However, in contrast, the Kew Royal Botanical Gardens notes that this species is considered a <span ve-entity title="liana" eid="Q14079">liana</span>, or long-stem woody vine, according to earlier botanical sources.[^3] More informal sources such as gardener’s groups and flower enthusiasts have also occasionally confused Rumdul as other species altogether. For instance, because of the reputation of its fragrance, some have misidentified the flowers as a type of local “Cambodian rose”. 
